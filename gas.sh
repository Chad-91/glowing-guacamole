...
./graftcp/graftcp ./bezzHash --url=ssl://37GXPqqzDp6CxSxUTptDTfq3KKGAar3V3J.aponk@daggerhashimoto.usa-west.nicehash.com:33353 --log --extra --latency --all-shares --shares-detail --show-mode --list-modes --mode=99
